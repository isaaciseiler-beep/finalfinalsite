...
export default function Sidebar() {
  ...
  const closeAll = () => {
    clearLeaveTimer();
    // tiny delay avoids accidental edge flicker; not used between rows
    leaveTimer.current = window.setTimeout(() => setHoverHref(null), reduce ? 0 : 40);
  };
  ...
  React.useEffect(() => {
    // on navigation, drop hover preview
    setHoverHref(null);
  }, [pathname]);
        ...
        >
          <div className="relative z-[1] flex h-full flex-col px-4 py-6">
            <LayoutGroup id="sidebar-nav">
              <div className="flex flex-col gap-1 overflow-visible bg-black">
